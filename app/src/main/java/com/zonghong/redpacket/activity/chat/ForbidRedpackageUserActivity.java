...
import com.zonghong.redpacket.adapter.group.SetGroupForbidRedpackageAdapter;
...
public class ForbidRedpackageUserActivity extends BaseActivity<FragmentContactsBinding> {

    private SetGroupForbidRedpackageAdapter contactsAdapter;
    ...
    public void initUI() {
        ...
        binding.includeToolbar.tvTitle.setText("设置禁止领红包");
    ...
    private void setmanager() {
        ...
        params.put("disabled_list", checkIds.substring(0, checkIds.length()));
        HttpClient.Builder.getServer().setAuth(UserService.getInstance().getToken(), params).observeOn(AndroidSchedulers.mainThread()).subscribeOn(Schedulers.io()).subscribe(new HttpObserver<Object>() {
            @Override
            public void onSuccess(BaseBean<Object> baseBean) {
                tipDialog = DialogUtils.getSuclDialog(ForbidRedpackageUserActivity.this, baseBean.getMsg(), true);
            ...
            public void onError(BaseBean<Object> baseBean) {
                tipDialog = DialogUtils.getFailDialog(ForbidRedpackageUserActivity.this, baseBean.getMsg(), true);
                tipDialog.show();
            }
        });
    }
            ...
            public void onSuccess(BaseBean<GroupUserListBean> baseBean) {
                if (contactsAdapter == null) {
                    if (baseBean.getData().getGUser() != null) {
                        contactsAdapter = new SetGroupForbidRedpackageAdapter(baseBean.getData().getGUser());
