...
public class CustomBiaoqingMessageView extends IContainerItemProvider.MessageProvider<ImageMessage> {
    ...
    public View newView(Context context, ViewGroup group) {
        ...
        CustomBiaoqingMessageView.ViewHolder holder = new CustomBiaoqingMessageView.ViewHolder();
    ...
    public void bindView(View v, int position, ImageMessage content, UIMessage message) {
        CustomBiaoqingMessageView.ViewHolder holder = (CustomBiaoqingMessageView.ViewHolder) v.getTag();
