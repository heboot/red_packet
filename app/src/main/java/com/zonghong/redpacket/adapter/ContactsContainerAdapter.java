...
public class ContactsContainerAdapter extends BaseQuickAdapter<ContatsChildBean, BaseViewHolder> {

    private boolean choose;

    public ContactsContainerAdapter(@Nullable List<ContatsChildBean> data, boolean choose) {
    ...
    protected void convert(BaseViewHolder helper, ContatsChildBean item) {
        ...
        binding.rvList.setAdapter(new ContactsAdapter(item.getList(), choose));
    }
}
