...
public class AddContactsGroupContainerAdapter extends BaseQuickAdapter<ContatsChildBean, BaseViewHolder> {


    public AddContactsGroupContainerAdapter(@Nullable List<ContatsChildBean> data) {
...
//        binding.rvList.setAdapter(new SetGroupManagerAdapter(item.getList()));
    }
}
