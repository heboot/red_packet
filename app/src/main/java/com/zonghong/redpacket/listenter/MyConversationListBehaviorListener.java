...
public class MyConversationListBehaviorListener implements RongIM.ConversationListBehaviorListener {
    ...
    public boolean onConversationClick(Context context, View view, UIConversation uiConversation) {
        if (uiConversation.getConversationType() == Conversation.ConversationType.GROUP) {
            RongUtils.toGroupChat(uiConversation.getConversationTargetId(), uiConversation.getUIConversationTitle());
        } else if (uiConversation.getConversationType() == Conversation.ConversationType.PRIVATE) {
            RongUtils.toChat(uiConversation.getConversationTargetId(), uiConversation.getUIConversationTitle());
        }
        return true;
    }
}
